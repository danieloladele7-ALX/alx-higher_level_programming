...
call plug#begin('/plugged')
	...
	" Plug 'tpoe/vim-rhubarb' " required by fugitive to :Gbrowse
	...
	"" beautiful status and tab bar
	Plug 'vim-airline/vim-airline'
	" Plug 'vim-airline/vim-arline-themes'
	
	"" devicons for trees and bars
	Plug 'ryanoasis/vim-devicons'

"" End of plugin managent
call plug#end()
